			...
			<div class="page-breadcrumb">
				<div class="row">
					<div class="col-12 align-self-center">
						<h4 class="page-title">Q&A 리스트</h4>
					</div>
				</div>
							...
							<div class="card">
								<div class="card-body">
									<form role="form" method="get">
										<div>
											<button type="submit" class="btn allBtn" style="float: left; text-align: center; text-color: white; 
													background-color: #D8D8D8; border-radius: 1px;">Q&A 작성하기</button>
										</div>
